...
/* One decoded RunEvent crossing from the stream goroutine to the Bubble Tea loop. The goroutine only writes to the channel; the model is mutated solely in Update (no shared-state race). */
